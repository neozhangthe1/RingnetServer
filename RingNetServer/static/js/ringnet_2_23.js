...
var ringnet = function(json) {
    ...
    $("#chart").empty();
    var outer = d3.select("#chart").append("svg:svg").attr("width", 3000).attr("height", 3000).attr("pointer-events", "all");
    ...
    function redraw() {
      ...
      for(var i = 0; i < trajectories.length; i++) {
        ...
        samples_dict[features] = index;
        index++;
      }
      //var clusterfck = require("clusterfck");
      clk = kmeans(samples, 20);
      ...
      for(var i = 0; i < clusters.length; i++) {
        for(var k = 0; k < clusters[i].length; k++) {
          index = samples_dict[clusters[i][k]];
